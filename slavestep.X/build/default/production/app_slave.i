...
# 1 "./app_config.h" 1
# 32 "./app_config.h"
_Bool APP_CONFIG_Load(AXIS_t *axis, MOTOR_t *motor, ENCODER_t *encoder);
_Bool APP_CONFIG_Save(const AXIS_t *axis, const MOTOR_t *motor, const ENCODER_t *encoder);
_Bool APP_CONFIG_IsValidInEeprom(void);
# 19 "app_slave.c" 2
# 35 "app_slave.c"
static AXIS_t axis;
...
void SLAVE_APP_Initialise(void) {
    ...
    IOCBF0_SetInterruptHandler(ENCODER_ISR_Update);
